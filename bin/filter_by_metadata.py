...
def main():
    ...
    if args.desh == None:
        ...
        desh_df = pd.read_csv(args.desh, sep='\t', header=0, dtype={'record_id':str, 'fasta_id':str,'nonN':int,'lineage':str,'date':str,'country':str, 'continent':str})
    ...
    if len(args.continent) != 0:
        ...
        metadata_df = metadata_df.loc[metadata_df["continent"].isin(continent_filter)]
